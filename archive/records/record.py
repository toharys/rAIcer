...
STACK_SIZE = 4
SAVE_FILENAME = "time_0.05_frame_stacks_with_commands.npz"
TERMINATE = False
    ...
    def capture_data(self, duration=60):
        ...
        try:
            ...
            while not TERMINATE:
                ...
                if t != 0 and not terminate:
                    self.recorded_data[t-1].append(stacked_frames.copy())
            ...
            self.recorded_data[-1].append(np.zeros_like(self.recorded_data[0][-1]))
