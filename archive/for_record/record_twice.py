...
STACK_SIZE = 4
SAVE_FILENAME =  "/media/raicer/7351-8BE8/only_line_207.h5"
SAVE_INTERVAL = 300
    ...
    def processing_thread(self):
        ...
        try:
            ...
            while not self.terminate:
                ...
                if current_time - self.last_sample_time >= 0.5:  # Fixed 2Hz sampling
                    try:
                        ...
                        if prev_stacked_frames is not None:
                            self.save_queue.put((prev_stacked_frames.copy(), self.current_action, stacked_frames.copy()))
